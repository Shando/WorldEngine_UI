...
# http://github.com/kevinwuhoo/randomcolor-py
# which is itself a port of http://github.com/davidmerfield/randomColor
# by David Merfield
...
#         You can pass a string representing a color name: red, orange, yellow, green, blue, purple, pink and
#         monochrome are currently supported.
#     Luminosity - Controls the luminosity of the generated color.
#         You can specify a string containing bright, light or dark.
...
#         Possible values are rgb, rgbArray, hsl, hslArray and hex (default).
